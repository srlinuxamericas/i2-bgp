...
drwxr-xr-x 4 root root   4096 Oct 27 22:28 cli
-rw-r--r-- 1 root root 291379 Oct 27 22:28 ipv4-address.png
-rw-r--r-- 1 root root   2538 Oct 27 22:28 srl-bgp.clab.yml
-rw-r--r-- 1 root root 216409 Oct 27 22:28 lab-topology.png
```
...
|                 |                         |                 |  s   |         |              |              |             |                         |
+=================+=========================+=================+======+=========+==============+==============+=============+=========================+
| default         | 172.16.10.50            | servers         | D    | 64500   | established  | 0d:0h:21m:56 | ipv4-       | [0/0/4]                 |
|                 |                         |                 |      |         |              | s            | unicast     |                         |
| default         | fe80::1830:6ff:feff:1%e | spines          | DB   | 65500   | established  | 0d:0h:9m:48s | ipv4-       | [2/2/2]                 |
|                 | thernet-1/1.0           |                 |      |         |              |              | unicast     |                         |
| default         | fe80::1841:7ff:feff:2%e | spines          | DB   | 65500   | established  | 0d:0h:10m:19 | ipv4-       | [2/1/3]                 |
|                 | thernet-1/2.0           |                 |      |         |              | s            | unicast     |                         |
+-----------------+-------------------------+-----------------+------+---------+--------------+--------------+-------------+-------------------------+
---------------------------------------------------------------------------------------------------------------------------------------------------------------
Summary:
0 configured neighbors, 0 configured sessions are established, 0 disabled peers
...
|                   |      |           |                     |         |    e    |        |           |           |           |           |           |
+===================+======+===========+=====================+=========+=========+========+===========+===========+===========+===========+===========+
| 1.1.1.1/32        | 4    | host      | net_inst_mgr        | True    | default | 0      | 0         | None      | None      |           |           |
| 2.2.2.2/32        | 0    | bgp       | bgp_mgr             | True    | default | 0      | 170       | fe80::183 | ethernet- |           |           |
|                   |      |           |                     |         |         |        |           | 0:6ff:fef | 1/1.0     |           |           |
|                   |      |           |                     |         |         |        |           | f:1       |           |           |           |
|                   |      |           |                     |         |         |        |           | (direct)  |           |           |           |
...
|                   |      |           |                     |         |         |        |           | f:1       |           |           |           |
|                   |      |           |                     |         |         |        |           | (direct)  |           |           |           |
| 20.20.20.20/32    | 0    | bgp       | bgp_mgr             | True    | default | 0      | 170       | fe80::184 | ethernet- |           |           |
|                   |      |           |                     |         |         |        |           | 1:7ff:fef | 1/2.0     |           |           |
|                   |      |           |                     |         |         |        |           | f:2       |           |           |           |
|                   |      |           |                     |         |         |        |           | (direct)  |           |           |           |
| 172.16.10.0/24    | 3    | local     | net_inst_mgr        | True    | default | 0      | 0         | 172.16.10 | irb0.0    |           |           |
|                   |      |           |                     |         |         |        |           | .254      |           |           |           |
|                   |      |           |                     |         |         |        |           | (direct)  |           |           |           |
| 172.16.10.254/32  | 3    | host      | net_inst_mgr        | True    | default | 0      | 0         | None      | None      |           |           |
| 172.16.10.255/32  | 3    | host      | net_inst_mgr        | True    | default | 0      | 0         | None      | None      |           |           |
+-------------------+------+-----------+---------------------+---------+---------+--------+-----------+-----------+-----------+-----------+-----------+
---------------------------------------------------------------------------------------------------------------------------------------------------------------
IPv4 routes total                    : 7
...
[ 172.16.10.50, fe80::1847:7ff:feff:2%ethernet-1/2.0 ]
--------------------------------------------------------------------------------------------------------------------------------
```
...
| u*>    | 2.2.2.2/32                          | fe80::1830:6ff:feff:1%ethernet-     |        |        |  i[65500, 64600]                                   |
|        |                                     | 1/1.0                               |        |        |                                                    |
| u*>    | 2.2.2.2/32                          | fe80::1841:7ff:feff:2%ethernet-     |        |        |  i[65500, 64600]                                   |
|        |                                     | 1/2.0                               |        |        |                                                    |
| u*>    | 10.10.10.10/32                      | fe80::1830:6ff:feff:1%ethernet-     |        |        |  i[65500]                                          |
|        |                                     | 1/1.0                               |        |        |                                                    |
| u*>    | 20.20.20.20/32                      | fe80::1841:7ff:feff:2%ethernet-     |        |        |  i[65500]                                          |
|        |                                     | 1/2.0                               |        |        |                                                    |
| u*>    | 172.16.10.0/24                      | 0.0.0.0                             |        |        |  i                                                 |
| u*>    | 172.17.10.0/24                      | fe80::1830:6ff:feff:1%ethernet-     |        |        |  i[65500, 64600]                                   |
|        |                                     | 1/1.0                               |        |        |                                                    |
| u*>    | 172.17.10.0/24                      | fe80::1841:7ff:feff:2%ethernet-     |        |        |  i[65500, 64600]                                   |
|        |                                     | 1/2.0                               |        |        |                                                    |
+--------+-------------------------------------+-------------------------------------+--------+--------+----------------------------------------------------+
---------------------------------------------------------------------------------------------------------------------------------------------------------------
9 received BGP routes: 8 used, 9 valid, 0 stale
9 available destinations: 0 with ECMP multipaths
---------------------------------------------------------------------------------------------------------------------------------------------------------------
```
...
|                 |                         |                 |  s   |         |              |              |             |                         |
+=================+=========================+=================+======+=========+==============+==============+=============+=========================+
| default         | 2.2.2.2                 | evpn-peers      | S    | 64600   | established  | 0d:0h:0m:5s  | evpn        | [0/0/0]                 |
| default         | 172.16.10.50            | servers         | D    | 64500   | established  | 0d:0h:35m:58 | ipv4-       | [0/0/4]                 |
|                 |                         |                 |      |         |              | s            | unicast     |                         |
| default         | fe80::1830:6ff:feff:1%e | spines          | DB   | 65500   | established  | 0d:0h:23m:50 | ipv4-       | [2/2/3]                 |
|                 | thernet-1/1.0           |                 |      |         |              | s            | unicast     |                         |
| default         | fe80::1841:7ff:feff:2%e | spines          | DB   | 65500   | established  | 0d:0h:24m:21 | ipv4-       | [3/3/4]                 |
|                 | thernet-1/2.0           |                 |      |         |              | s            | unicast     |                         |
+-----------------+-------------------------+-----------------+------+---------+--------------+--------------+-------------+-------------------------+
---------------------------------------------------------------------------------------------------------------------------------------------------------------
Summary:
